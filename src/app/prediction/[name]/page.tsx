const getPredictedAge = async (name: string) => {
  // const res=await fetch(`https://api.agify.io/?name=fatih`)
...
//! bu file SERVER componenttir.!!!
//! npx create-next-app
//! yarn dev   to start app
//! https://api.genderize.io/?name=peter    for API fetch
//! https://api.nationalize.io/?name=fatih
//! https://api.agify.io/?name=fatih
